...
import Optionstrategy from '@/components/custom/OptionStrategy'
import Gttorder from '@/components/custom/GttOrder';
import Smartbasket from '@/components/custom/SmartBasket';
import Actionableresearch from '@/components/custom/ActionableResearch';
import Optionchain from '@/components/custom/OptionChain'
         ...
         data-[state=inactive]:text-[#2B2A29] "
          ...
          data-[state=inactive]:text-[#2B2A29]"
                    ...
                    <div className="h-auto place-items-center sm:place-items-end">
                        ...
                        <TabsContent value="smart" className="flex items-center justify-center mt-0">
                            <Smartbasket />
                        </TabsContent>
                        ...
                        <TabsContent value="chain" className="flex items-center justify-center mt-0">
                            <Optionchain />
                        </TabsContent>
                    </div>
